...
void draw_table_top(glm::mat4 view_matrix) {
  draw_texcub(view_matrix, &table_top_vao, "images/floor.bmp");
}
...
void draw_table_leg1(glm::mat4 view_matrix) {
  draw_texcub(view_matrix, &table_leg1_vao, "images/floor.bmp");
}
...
void draw_table_leg2(glm::mat4 view_matrix) {
  draw_texcub(view_matrix, &table_leg2_vao, "images/floor.bmp");
}
...
void draw_table_leg3(glm::mat4 view_matrix) {
  draw_texcub(view_matrix, &table_leg3_vao, "images/floor.bmp");
}
...
void draw_table_leg4(glm::mat4 view_matrix) {
  draw_texcub(view_matrix, &table_leg4_vao, "images/floor.bmp");
}
